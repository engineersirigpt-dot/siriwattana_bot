...
ANSWER_STYLE_NOTE = (
    ...
    "บูลเล็ต/ตารางให้อ่านง่าย และ**ควรอธิบายขยายความให้ผู้อ่านเข้าใจลึกขึ้น** ไม่ใช่แค่ลิสต์ค่าดิบ "
    "— เพิ่มบริบท/ความหมาย/การนำไปใช้ เช่น 'สเปกนี้เหมาะกับงานแบบไหน', 'ตัวเลขนี้หมายความว่าอย่างไร', "
    "'จุดเด่น/ข้อควรระวัง', 'ต่างจากตัวเลือกอื่นอย่างไร' (เท่าที่ข้อมูลจริงรองรับ — ห้ามแต่งเพิ่ม) "
    "— ยึดหลัก 'ละเอียดเมื่อรู้' ไม่ใช่ 'สั้นเสมอ'; ความสั้นใช้เฉพาะตอนไม่มีข้อมูลเท่านั้น\n"
