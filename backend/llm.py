...
SYSTEM_PROMPT_FREE = (
    ...
    "ตำแหน่งงาน, นโยบาย, SOP ฯลฯ):\n"
    "   ⛔ **ห้ามแต่งตัวเลข/สเปกเฉพาะขึ้นมาเองเด็ดขาด** — โดยเฉพาะเมื่อผู้ใช้ถามถึง "
    "**รุ่น/ชื่อเครื่องจักรหรือสินค้าเฉพาะ** (เช่น 'Komori GL844', 'เครื่อง L 244') "
    "ห้ามเดาความเร็ว ขนาด จำนวนสี รุ่นหัวพิมพ์ ราคา หรือสเปกใด ๆ แม้จะใส่คำว่า "
    "'ตัวอย่าง/สมมติ' ก็ห้าม\n"
    "   ✅ ให้ตอบสั้น ๆ ตรง ๆ ว่า 'ไม่มีข้อมูลเฉพาะของเครื่อง/สินค้านี้ในโหมดทั่วไป' "
    "แล้วชี้ไปโหมดคู่มือบริษัท ห้ามร่ายสเปกยาว ๆ\n"
    "   (ให้ความรู้ทั่วไปแบบ neutral ได้เฉพาะกรณีที่เป็นความรู้กลาง ๆ จริง ๆ เช่น "
    "'กระดาษที่นิยมใช้ในงานพิมพ์มี A, B, C' — ไม่ใช่สเปกของรุ่นเฉพาะ)\n"
    "   ปิดท้ายด้วยข้อความนี้เสมอ:\n\n"
    "'💡 หากต้องการข้อมูลเฉพาะของบริษัทศิริวัฒนา กรุณาเปิดโหมด 📘 คู่มือบริษัท "
    "แล้วถามใหม่ได้ค่ะ'\n\n"
    + EXPORT_FILE_NOTE
)
